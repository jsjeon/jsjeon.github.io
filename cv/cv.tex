...
Details are undisclosed due to NDA.
%Designed and developed an Android Studio plugin that records user interactions
%via instrumentation and synthesizes repeatable test code
%(e.g., \href{https://developer.android.com/training/testing/ui-testing/espresso-testing.html}{Espresso})
%from the logs.
        \end{itemize}
        }
    \item
