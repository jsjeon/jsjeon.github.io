...
\cvachievement{\faTrophy}{4 Spot bonuses}{Kotlin compiler testing and UAST migration at Google scale}

\divider

\cvachievement{\faHeartbeat}{18 Peer bonuses}{Helping several partner teams and colleagues; fixing long-standing issues; beefing up tests; etc.}
